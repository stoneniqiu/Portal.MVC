...
namespace Niqiu.Core.Domain.User
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        public virtual string GetUrlReferrer()
        {
            ...
            if (IsRequestAvailable(HttpContext) && HttpContext.Request.UrlReferrer != null)
        ...
        public virtual bool IsCurrentConnectionSecured()
        {
            ...
            if (IsRequestAvailable(HttpContext))
            {
                ...
                //just uncomment it
                //useSSL = HttpContext.Request.ServerVariables["HTTP_CLUSTER_HTTPS"] == "on" ? true : false;
            }
        ...
        public virtual T QueryString<T>(string name)
        {
            ...
            if (IsRequestAvailable(HttpContext) && HttpContext.Request.QueryString[name] != null)
        ...
        public virtual void RestartAppDomain(bool makeRedirect = false, string redirectUrl = "")
        {
            ...
            else
            {
                ...
                if (!success)
                {
                    throw new PortalException("portal needs to be restarted due to a configuration change, but was unable to do so." + Environment.NewLine +
